...
exports.forgetPassword = async (req, res) => {
  try {
    ...
    const sendPasswordResetEmail = async (user, resetToken, transporter, res) => {
        try {
          // Email content with HTML for styling and a clickable link
          const mailOptions = {
      ...
      // Example usage
      // sendPasswordResetEmail(user, resetToken, transporter, res);

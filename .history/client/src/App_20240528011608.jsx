...
import backgroundImage from "./assets/girls2.jpg"; // Adjust the path according to your project structure
  ...
  return (
    <Router>
      <div
        ...
        style={{
          position: "sticky", // Ensure relative positioning for the overlay

...
export default function App() {
  return (
    <div className="max-w-full gap-2 grid grid-cols-12 grid-rows-3 px-8 mt-32 ">
      {/* First Row */}
      <Card className="col-span-12 sm:col-span-3 h-[300px] bg-[#000000bd]">
        <CardHeader className="absolute z-10 top-1 flex-col !items-start bg-[#000000bd]">
          <p className="text-tiny text-white/60 uppercase font-bold">
            Game of the Month
          </p>
          <h4 className="text-white font-medium text-large glow bg-[#000000bd]">

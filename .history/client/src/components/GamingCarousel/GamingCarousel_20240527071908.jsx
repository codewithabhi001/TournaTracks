...
const GamingCarousel = () => {
  return (
    <div className="text-white p-8 mb-12">
      ...
      <Carousel
        ...
        autoPlay={true}
        autoPlaySpeed={3000} // Adjust slide speed here (in milliseconds)
      >
        {games.map((game, index) => (
          ...
          >
            <motion.div
              ...
              whileTap={{ scale: 0.9 }}
              className="border-4 border-transparent rounded-lg bg-gradient-to-r from-purple-900 via-black to-blue-900 p-1"
            >
              <motion.img
                src={`/${game.src}`}
                alt={game.title}
            ...
            <motion.p
              className="mt-2 text-center text-lg font-bold bg-gradient-to-r from-white via-[#a39595] to-white bg-clip-text text-transparent"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: index * 0.2 }}
            >

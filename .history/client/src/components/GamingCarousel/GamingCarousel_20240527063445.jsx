...
const GamingCarousel = () => {
  return (
    <div className="text-white p-8 bg-gradient-to-r from-purple-900 via-black to-blue-900">
      ...
      >
        {games.map((game, index) => (
          ...
          >
            ...
            <p className="mt-2 text-center text-lg font-bold bg-gradient-to-r from-purple-900 via-black to-blue-900 bg-clip-text text-transparent">
              {game.title}
            </p>
          </motion.div>
        ))}

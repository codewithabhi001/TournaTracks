      ...
      <NavbarContent className="sm:hidden pr-3" justify="center">
        <NavbarBrand>
          <Link to="/" className="flex items-center">
            <AcmeLogo className="mr-2 animate-pulse" />
          ...
          (category, index) => (
            ...
            >
              <Link to="#" className="nav-link inline-block flex items-center">
                {category === "Features" && (
                  <GiConsoleController className="mr-1" />
                )}
                {category === "Customers" && <MdViewList className="mr-1" />}
                {category === "Pricing" && (
                  <Button
                    variant="flat"
                    className="mr-1 bg-gradient-to-r from-[#7b4397] to-[#dc2430] hover:from-[#6a11cb] hover:to-[#2575fc] text-white font-bold py-2 rounded-md transform transition duration-300 hover:scale-105"
                  >
                    Pricing
                  </Button>
                )}

      ...
      <NavbarContent justify="end">
        ...
        <NavbarItem>
          <Button
            ...
            to="/login"
            variant="flat"
            className="glow-button bg-gradient-to-r from-[#2d794a] to-[#2575fc] hover:from-[#6a11cb] hover:to-[#2575fc] text-white font-bold py-2 rounded-md px-4 transform transition duration-300 hover:scale-105 flex items-center"

      ...
      <NavbarContent className="hidden sm:flex gap-4 !justify-center font-bold">
        <NavbarItem>
          <Dropdown>
            ...
            <DropdownMenu aria-label="Features Options">
              <DropdownItem>
                <Link to="/features/feature1" className="dropdown-link">
                  Feature 1
                </Link>
              </DropdownItem>
              <DropdownItem>
                <Link to="/features/feature2" className="dropdown-link">
                  Feature 2
                </Link>
              </DropdownItem>
              <DropdownItem>
                <Link to="/features/feature3" className="dropdown-link">
                  Feature 3
                </Link>
              </DropdownItem>
            </DropdownMenu>
        ...
        <NavbarItem>
          <Dropdown>
            ...
            <DropdownMenu aria-label="Customers Options">
              <DropdownItem>
                <Link to="/customers/customer1" className="dropdown-link">
                  Customer 1
                </Link>
              </DropdownItem>
              <DropdownItem>
                <Link to="/customers/customer2" className="dropdown-link">
                  Customer 2
                </Link>
              </DropdownItem>
              <DropdownItem>
                <Link to="/customers/customer3" className="dropdown-link">
                  Customer 3
                </Link>
              </DropdownItem>
            </DropdownMenu>
        ...
        <NavbarItem>
          <Dropdown>
            ...
            <DropdownMenu aria-label="Dashboard Options">
              <DropdownItem>
              ...
              <DropdownItem>
                <Link to="/dashboard/stats" className="dropdown-link">
                  Stats
                </Link>
              </DropdownItem>
              <DropdownItem>
                <Link to="/dashboard/reports" className="dropdown-link">
                  Reports
                </Link>
              </DropdownItem>
            </DropdownMenu>

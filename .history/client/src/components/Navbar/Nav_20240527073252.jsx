...
export default function Nav() {
  ...
  return (
    <Navbar
      ...
      className=" bg-[#00000000]  sm:px-[5vw] font-poppins"
    >
        ...
        {categories.map((category, index) => (
          ...
          >
            ...
            {category.subLinks.length > 0 && (
              <div
                className={`dropdown-menu absolute left-0 mt-2 py-2 w-80 bg-gradient-to-r from-[#000000] to-[#000000] text-white rounded shadow-lg ${

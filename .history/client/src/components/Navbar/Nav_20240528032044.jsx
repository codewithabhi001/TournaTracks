      ...
      <NavbarContent className="hidden sm:flex gap-4 !justify-center font-bold">
        {categories.map((category, index) => (
          ...
          >
            ...
            <div
            className={`dropdown-menu absolute left-0 mt-2 py-2 w-48 bg-gradient-to-r from-[#1a1a1a] to-[#000000] text-white rounded-lg shadow ${
          ...
          >
            <h3 className="text-xl font-bold mb-2">Gaming Menu</h3>
            <ul>
              <li className="hover:bg-gray-700 hover:text-yellow-400 px-4 py-2">Games</li>
              <li className="hover:bg-gray-700 hover:text-yellow-400 px-4 py-2">Consoles</li>
              <li className="hover:bg-gray-700 hover:text-yellow-400 px-4 py-2">Accessories</li>
              <li className="hover:bg-gray-700 hover:text-yellow-400 px-4 py-2">Community</li>
            </ul>
          </div>

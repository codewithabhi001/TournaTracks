        ...
        {categories.map((category, index) => (
          ...
          >
            ...
            {category.subLinks.length > 0 && (
              <div
                className={`dropdown-menu absolute left-0 mt-2 py-2 w-48 text-white rounded-lg shadow- ${
                ...
                style={{
                  ...
                  background: "linear-gradient(to right, #000000, #000000)", // Ensure the background gradient
                }}
              >
                {category.subLinks.map((item) => (
                  <Link
                    key={item.name}
                    to={item.link}
                    className="block px-4 py-2 text-sm hover:bg-[#d3d1d334] transition-colors duration-300 text-gray-50"

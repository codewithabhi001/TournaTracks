      ...
      <div className="flex flex-col md:flex-row  rounded-lg overflow-hidden  border border-gray-700 w-full max-w-4xl shadow-lg">
        <div className="p-10 text-white w-full md:w-1/2">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className={`bg-gradient-to-r from-[#7b4397] via-[#6824dc] to-[#6a11cb] hover:from-blue-500 hover:to-[#dc2430] text-white py-2 rounded-md w-full transform transition duration-300 hover:scale-105 ${

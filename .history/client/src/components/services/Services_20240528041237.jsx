...
function ServiceCard({ title, description, color }) {
  return (
    <div
      className={`relative rounded-lg p-8 overflow-hidden group border-2 border-${color}-500 mb-10 transition-all ease-out hover:shadow-[0_4px_0px_rgb(0,0,0)] hover:translate-y-1`}
      style={{
    ...
    >
      <div className="absolute inset-0 bg-opacity-50 bg-gray-900 blur-sm group-hover:blur-md transition duration-300"></div>
      <div

...
function ServiceCard({ title, description, color }) {
  return (
    <div
      className="relative rounded-lg overflow-hidden group mb-10 transition-all ease-out hover:translate-y-1 border-2 border-white bg-white"
      style={{
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-black via-[#6f036d] to-black opacity-60 transition duration-300 group-hover:opacity-50"></div>
      <div

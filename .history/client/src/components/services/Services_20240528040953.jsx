...
function Services() {
  return (
    <div className="container mx-auto mt-10 px-8 mt-28">
...
function ServiceCard({ title, description, color }) {
  return (
    <div
      className={`relative rounded-lg p-8 overflow-hidden group border-2 border-${color}-500 mb-20 transition-all ease-out hover:shadow-[0_4px_0px_rgb(0,0,0)] hover:translate-y-1`}
      style={{

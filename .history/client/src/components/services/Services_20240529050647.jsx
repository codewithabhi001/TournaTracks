  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-8">
        <h3 className="text-2xl sm:text-xl text-white mb-4">{title}</h3>
        <p className="text-xl sm:text-lg text-white mb-4">{price}</p>
        <ul className="text-lg sm:text-sm text-white mb-4 list-disc pl-5">
          {features.map((feature, index) => (
            <li key={index}>{feature}</li>
          ))}
        </ul>
        <p className="text-lg sm:text-sm text-white mb-2 font-semibold">

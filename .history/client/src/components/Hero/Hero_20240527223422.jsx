    ...
    >
      ...
      <div className="relative z-10 text-center p-8 max-w-screen-lg mx-auto">
        <motion.h1
          ...
          className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-4 bg-gradient-to-r via-pink-800 via-pink-800 to-blue-500 bg-clip-text text-transparent animate-gradient drop-shadow-glow"
        >

...
import backgroundImage from "../assets/girls2.jpg"; // Adjust the path based on the folder structure

const HeroSection = () => {
  return (
    <div
      className="relative text-white   mb-48 flex flex-col items-center justify-center overflow-hidden bg-black h-screen"
      style={{
        backgroundImage: `url(${backgroundImage})`, // Corrected the variable name

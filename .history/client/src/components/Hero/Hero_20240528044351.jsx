...
const HeroSection = () => {
  return (
    <div
      className="relative text-white flex items-center justify-center h-screen bg-cover bg-no-repeat bg-center w-full"
      style={{
    ...
    >
      ...
      <div className="relative z-10 text-left p-8 max-w-screen-lg mx-auto flex flex-col md:flex-row items-start md:items-center justify-between">
        ...
        <div className="md:w-1/3 mt-8 md:mt-0 flex justify-center">
          ...
          <div className="w-64 h-64 bg-gray-800 bg-opacity-50 flex items-center justify-center rounded-lg">

      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full  mx-auto px-8 py-12">
        <div className="w-full md:w-auto text-center md:text-left p-8">
          <motion.h1
            ...
            className="text- md:text-6xl lg:text-6xl font-extrabold mb-1 bg-gradient-to-r from-[#d2add3] via-pink- to-[#aa0df3] bg-clip-text text-transparent animate-gradient drop-shadow-glow"
          >

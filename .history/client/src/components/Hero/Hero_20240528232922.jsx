...
const HeroSection = () => {
  return (
    ...
    >
      <div className="overlay absolute top-0 left-0 w-full h-full bg-black bg-opacity-60"></div>
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl mx-auto px-8 py-12">
        <div className="md:w-1/2 text-center md:text-left p-8">
          <motion.h1
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 1 }}
            className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-4 bg-gradient-to-r from-[#be499d] via-pink-500 to-[#7a036c] bg-clip-text text-transparent animate-gradient drop-shadow-glow w-fit"
          >
